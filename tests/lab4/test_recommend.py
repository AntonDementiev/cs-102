...
from src.lab4.recommend import Recommend, history_file, films_file, user_views
...
class TestRecommend(unittest.TestCase):
    def test_load_movies(self):
        ...
        recommendation_service = Recommend(films_file, history_file, user_views)
    ...
    def test_filter_users(self):
        expected_filtered_users = [[2, 1, 3], [1, 4, 3], [2, 2, 2, 2, 2, 3]]
        recommendation_service = Recommend(films_file, history_file, user_views)
    ...
    def test_exclude_watched_movies(self):
        filtered_users = [[1, 2, 3], [1, 2], [1, 2, 4, 5]]
        expected_unwatched_movies = [3, 4, 5]
        recommendation_service = Recommend(films_file, history_file, user_views)
        result = recommendation_service.exclude_watched_films(
            user_views, filtered_users
        )
